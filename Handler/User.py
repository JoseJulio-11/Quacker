...
def getUsersPerDay():
    ...
    userperday = dict()
    userperday[str((weekBefore).date())] = usersPerDayHelper(weekBefore, oneDay)
    userperday[str((weekBefore+oneDay).date())] = usersPerDayHelper(weekBefore+oneDay, oneDay)
    userperday[str((weekBefore+oneDay+oneDay).date())] = usersPerDayHelper(weekBefore+oneDay+oneDay, oneDay)
    userperday[str((weekBefore+oneDay+oneDay+oneDay).date())] = usersPerDayHelper(weekBefore+oneDay+oneDay+oneDay, oneDay)
    userperday[str((weekBefore+oneDay+oneDay+oneDay+oneDay).date())] = usersPerDayHelper(weekBefore+oneDay+oneDay+oneDay+oneDay, oneDay)
    userperday[str((weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay).date())] = usersPerDayHelper(weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay, oneDay)
    userperday[str((weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay+oneDay).date())] = usersPerDayHelper(weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay+oneDay, oneDay)
