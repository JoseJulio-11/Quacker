...
def getTopicsPerDay():
    ...
    topicperday = dict()
    topicperday[str(weekBefore)] = topicsPerDayHelper(weekBefore, oneDay)
    topicperday[str(weekBefore+oneDay)] = topicsPerDayHelper(weekBefore+oneDay, oneDay)
    topicperday[str(weekBefore+oneDay+oneDay)] = topicsPerDayHelper(weekBefore+oneDay+oneDay, oneDay)
    topicperday[str(weekBefore+oneDay+oneDay+oneDay)] = topicsPerDayHelper(weekBefore+oneDay+oneDay+oneDay, oneDay)
    topicperday[str(weekBefore+oneDay+oneDay+oneDay+oneDay)] = topicsPerDayHelper(weekBefore+oneDay+oneDay+oneDay+oneDay, oneDay)
    topicperday[str(weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay)] = topicsPerDayHelper(weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay, oneDay)
    topicperday[str(weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay+oneDay)] = topicsPerDayHelper(weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay+oneDay, oneDay)
...
def getMessagesPerDay():
    ...
    oneDay = datetime.timedelta(days=1)
    messperday = dict()
    messperday[str(weekBefore)] = messagesPerDayHelper(weekBefore, oneDay)
    messperday[str(weekBefore+oneDay)] = messagesPerDayHelper(weekBefore+oneDay, oneDay)
    messperday[str(weekBefore+oneDay+oneDay)] = messagesPerDayHelper(weekBefore+oneDay+oneDay, oneDay)
    messperday[str(weekBefore+oneDay+oneDay+oneDay)] = messagesPerDayHelper(weekBefore+oneDay+oneDay+oneDay, oneDay)
    messperday[str(weekBefore+oneDay+oneDay+oneDay+oneDay)] = messagesPerDayHelper(weekBefore+oneDay+oneDay+oneDay+oneDay, oneDay)
    messperday[str(weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay)] = messagesPerDayHelper(weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay, oneDay)
    messperday[str(weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay+oneDay)] = messagesPerDayHelper(weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay+oneDay, oneDay)
...
def getReplyPerDay():
    ...
    oneDay = datetime.timedelta(days=1)
    messperday = dict()
    messperday[str(weekBefore)] = replyPerDayHelper(weekBefore, oneDay)
    messperday[str(weekBefore+oneDay)] = replyPerDayHelper(weekBefore+oneDay, oneDay)
    messperday[str(weekBefore+oneDay+oneDay)] = replyPerDayHelper(weekBefore+oneDay+oneDay, oneDay)
    messperday[str(weekBefore+oneDay+oneDay+oneDay)] = replyPerDayHelper(weekBefore+oneDay+oneDay+oneDay, oneDay)
    messperday[str(weekBefore+oneDay+oneDay+oneDay+oneDay)] = replyPerDayHelper(weekBefore+oneDay+oneDay+oneDay+oneDay, oneDay)
    messperday[str(weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay)] = replyPerDayHelper(weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay, oneDay)
    messperday[str(weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay+oneDay)] = replyPerDayHelper(weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay+oneDay, oneDay)
    return jsonify(Messages=messperday)
...
def getLikesPerDay():
    ...
    oneDay = datetime.timedelta(days=1)
    likesperday = dict()
    likesperday[str(weekBefore)] = likesPerDayHelper(weekBefore, oneDay)
    likesperday[str(weekBefore+oneDay)] = likesPerDayHelper(weekBefore+oneDay, oneDay)
    likesperday[str(weekBefore+oneDay+oneDay)] = likesPerDayHelper(weekBefore+oneDay+oneDay, oneDay)
    likesperday[str(weekBefore+oneDay+oneDay+oneDay)] = likesPerDayHelper(weekBefore+oneDay+oneDay+oneDay, oneDay)
    likesperday[str(weekBefore+oneDay+oneDay+oneDay+oneDay)] = likesPerDayHelper(weekBefore+oneDay+oneDay+oneDay+oneDay, oneDay)
    likesperday[str(weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay)] = likesPerDayHelper(weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay, oneDay)
    likesperday[str(weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay+oneDay)] = likesPerDayHelper(weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay+oneDay, oneDay)
...
def getDislikesPerDay():
    ...
    oneDay = datetime.timedelta(days=1)
    dislikesperday = dict()
    dislikesperday[str(weekBefore)] = dislikesPerDayHelper(weekBefore, oneDay)
    dislikesperday[str(weekBefore+oneDay)] = dislikesPerDayHelper(weekBefore+oneDay, oneDay)
    dislikesperday[str(weekBefore+oneDay+oneDay)] = dislikesPerDayHelper(weekBefore+oneDay+oneDay, oneDay)
    dislikesperday[str(weekBefore+oneDay+oneDay+oneDay)] = dislikesPerDayHelper(weekBefore+oneDay+oneDay+oneDay, oneDay)
    dislikesperday[str(weekBefore+oneDay+oneDay+oneDay+oneDay)] = dislikesPerDayHelper(weekBefore+oneDay+oneDay+oneDay+oneDay, oneDay)
    dislikesperday[str(weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay)] = dislikesPerDayHelper(weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay, oneDay)
    dislikesperday[str(weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay+oneDay)] = dislikesPerDayHelper(weekBefore+oneDay+oneDay+oneDay+oneDay+oneDay+oneDay, oneDay)
